...
/// Lookup a cipher suite ID to a human-readable name.
...
/// Lookup a signature algorithm ID to a human-readable name.
...
/// Lookup a named group ID to a human-readable name.
